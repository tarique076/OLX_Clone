localStorage.setItem('category', 'commercial')
...
let getData = async () =>{
    try{
        let res = await fetch(' https://myserverolx.herokuapp.com/items?category=commercial');
...
document.querySelector('#loc_utt').addEventListener('click',async function(){
    try{
        let res = await fetch('https://myserverolx.herokuapp.com/items?category=commercial&location=Uttarakhand');
        let data = await res.json();
...
document.querySelector('#loc_bihar').addEventListener('click',async function(){
    try{
        let res = await fetch('https://myserverolx.herokuapp.com/items?category=commercial&location=Bihar');
        let data = await res.json();
...
document.querySelector('#loc_jh').addEventListener('click',async function(){
    try{
        let res = await fetch('https://myserverolx.herokuapp.com/items?category=commercial&location=Jharkhand');
        let data = await res.json();
...
document.querySelector('#loc_dl').addEventListener('click',async function(){
    try{
        let res = await fetch('https://myserverolx.herokuapp.com/items?category=commercial&location=Delhi');
        let data = await res.json();
...
document.querySelector('#loc_kl').addEventListener('click',async function(){
    try{
        let res = await fetch('https://myserverolx.herokuapp.com/items?category=commercial&location=Kerala');
        let data = await res.json();
...
document.querySelector('#loc_ga').addEventListener('click',async function(){
    try{
        let res = await fetch('https://myserverolx.herokuapp.com/items?category=commercial&location=Goa');
        let data = await res.json();
