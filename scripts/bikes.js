...
let getData = async () =>{
    try{
        let res = await fetch(' https://myserverolx.herokuapp.com/items?category=bike');
...
document.querySelector('#loc_utt').addEventListener('click',async function(){
    try{
        let res = await fetch('https://myserverolx.herokuapp.com/items?category=bike&location=Uttarakhand');
        let data = await res.json();
...
document.querySelector('#loc_bihar').addEventListener('click',async function(){
    try{
        let res = await fetch('https://myserverolx.herokuapp.com/items?category=bike&location=Bihar');
        let data = await res.json();
...
document.querySelector('#loc_jh').addEventListener('click',async function(){
    try{
        let res = await fetch('https://myserverolx.herokuapp.com/items?category=bike&location=Jharkhand');
        let data = await res.json();
...
document.querySelector('#loc_dl').addEventListener('click',async function(){
    try{
        let res = await fetch('https://myserverolx.herokuapp.com/items?category=bike&location=Delhi');
        let data = await res.json();
...
document.querySelector('#loc_kl').addEventListener('click',async function(){
    try{
        let res = await fetch('https://myserverolx.herokuapp.com/items?category=bike&location=Kerala');
        let data = await res.json();
...
document.querySelector('#loc_ga').addEventListener('click',async function(){
    try{
        let res = await fetch('https://myserverolx.herokuapp.com/items?category=bike&location=Goa');
        let data = await res.json();
