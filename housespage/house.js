...
let getData = async () =>{
    try{
        let res = await fetch(' http://localhost:3000/items?category=house');
...
document.querySelector('#loc_utt').addEventListener('click',async function(){
    try{
        let res = await fetch('http://localhost:3000/items?category=house&location=Uttarakhand');
        let data = await res.json();
...
document.querySelector('#loc_bihar').addEventListener('click',async function(){
    try{
        let res = await fetch('http://localhost:3000/items?category=house&location=Bihar');
        let data = await res.json();
...
document.querySelector('#loc_jh').addEventListener('click',async function(){
    try{
        let res = await fetch('http://localhost:3000/items?category=house&location=Jharkhand');
        let data = await res.json();
...
document.querySelector('#loc_dl').addEventListener('click',async function(){
    try{
        let res = await fetch('http://localhost:3000/items?category=house&location=Delhi');
        let data = await res.json();
...
document.querySelector('#loc_kl').addEventListener('click',async function(){
    try{
        let res = await fetch('http://localhost:3000/items?category=house&location=Kerala');
        let data = await res.json();
...
document.querySelector('#loc_ga').addEventListener('click',async function(){
    try{
        let res = await fetch('http://localhost:3000/items?category=house&location=Goa');
        let data = await res.json();
